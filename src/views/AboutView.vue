...
<template>
  ...
  <main class="pt-0 md:pt-0">
    <section class="flex items-center justify-center md:flex-row bg-Toko-hijau h-screen w-auto">
      <div class="container mx-auto flex mt-16 items-center flex-col md:flex-row">
        ...
        <transition name="fade-left">
          <div
            v-if="showHeroImage"
            class="md:w-1/2 w-0 md:flex justify-end relative top-16">
            <img
              src="../assets/Hero/stairs holding panel.png"
              alt="Hero Image" />
          </div>
        </transition>
      </div>
